...
<html>
<head>	
	<title>Laporan Distribusi Dinas</title>
	...
	<section>
		<div class="container">
			<div class="row pt-4 justify-content-center">
				<a href="<?php echo base_url().'olah'?>"><button class="btn btn-secondary text-center">Data Keseluruhan</button></a>
			</div>
					...
					<tbody>
							...
							<?php if ($lap->status=="Diterima") {?>
								...
								<tr class="text-center">	
									...
									<td style="color: green;"><?php echo $lap-> status ?></td>
									<td>
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#lihat<?=$lap->id_laporan;?>">Lihat Lengkap</button>
									</td>
								</tr>
							<?php }}?>
					</tbody>
