	...
	<div class="container">
		<div class="row text-center">
			<div class="col">
				...
				<p>(BPDB)</p>
				<br>
				<input type="text" name="username" id="username" placeholder="username" required="isi username anda">
				<br>
				<br>
				<br>
				<input type="password" name="password" id="pass" placeholder="password" required="si password anda">
				<br>
				<br>
				<br>
